...
const Whatsapp = () => {
  return (
    <a className="fixed bottom-3 right-3" href="https://wa.me/+51907529936" target="_blank" rel="noopener noreferrer">
        ...
        <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-green-400 rounded-full">
          ...
          >
            <path
              ...
              className="group-hover:fill-green-400 fill-white duration-300"
            ></path>
          </svg>
        </div>
      </button>
